        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold mt-1">
              {statistics?.total || statistics?.overview?.total || 0}
            </p>
          </div>
      ...
      <CardContent className="p-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold mt-1">
              {statistics?.new || statistics?.overview?.new || 0}
            </p>
          </div>
          <div className="bg-white/20 p-2 rounded-lg">
      ...
      <CardContent className="p-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold mt-1">
              {statistics?.in_progress || statistics?.overview?.in_progress || 0}
            </p>
          </div>
          <div className="bg-white/20 p-2 rounded-lg">
      ...
      <CardContent className="p-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold mt-1">
              {statistics?.resolved || statistics?.overview?.resolved || 0}
            </p>
          </div>
          <div className="bg-white/20 p-2 rounded-lg">
      ...
      <CardContent className="p-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-2xl font-bold mt-1">
              {statistics?.urgent || statistics?.priority?.urgent || statistics?.high_priority || 0}
            </p>
          </div>
          <div className="bg-white/20 p-2 rounded-lg">
